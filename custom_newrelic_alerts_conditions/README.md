...
1. Write the JSON schema describing your resource, `newrelic-alerts-condition.json`
2. Implement your resource handlers in `newrelic_alerts_condition/handlers.py`
