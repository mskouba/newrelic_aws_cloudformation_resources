# NewRelic::Alerts::Policy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `newrelic-alerts-policy.json`
2. Implement your resource handlers in `newrelic_alerts_policy/handlers.py`
