...
1. Write the JSON schema describing your resource, `newrelic-alerts-notificationchannel.json`
2. Implement your resource handlers in `newrelic_alerts_notificationchannel/handlers.py`
